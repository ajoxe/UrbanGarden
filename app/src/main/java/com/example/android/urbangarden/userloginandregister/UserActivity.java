...
//                intent.putExtra("myGardenList", "");
            ...
            case R.id.my_posts:
                Intent intent1 = new Intent(UserActivity.this, MyPostsActivity.class);
//                intent.putExtra("myGardenList", "");
            ...
            case R.id.fav_list:
                ...
                Intent intent2 = new Intent(UserActivity.this, MyGardensActivity.class);
//                intent.putExtra("myGardenList", "");
            ...
            case R.id.setting:
                Intent intent3 = new Intent(UserActivity.this, SettingsActivity.class);
//                intent.putExtra("myGardenList", "");
